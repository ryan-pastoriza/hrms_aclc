<?php 
	...
	foreach ($semiMonthlyBracket as $key => $value) {
	...
	$tableVars = array('tableHeaders' => array("Status","Salary Base","Base Tax","% Over"),
						'tableRows' => $tblRows,
						'tableId' => 'wtax-semi-monthly-table',
						'tblVarName' => 'smiMonthlyTbl',
						'collapsed' => true,
						'tableOptions' => array());
	...
	echo lte_widget(5,array('header' => "WTAX Table <i>(Semi-monthly)</i>",
						'body' => $tbl,
						'collapsable' => true,
