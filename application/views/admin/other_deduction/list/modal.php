  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?= form_open(base_url('index.php/admin/deduction/add_payment'), 'id=payment_form') ?>
        	<table id="paymentTable">
            <tr>
              <td><p><b>Date Filed:</b></p></td>
              <td><p id="date"></p><input type="hidden" name="eod_id"></td>
            </tr>
        		<tr>
        		...
        		<tr>
        			<td><p><b>Deduction Name:</b></p></td>
        			<td><p id="deduc_name"></p></td>
        		</tr>
        		<tr>
        			<td><p><b>Amount to deduct:</b></p></td>
        			<td><p id="amt"></p></td>
        		</tr>
            <tr>
              <td><p><b>Term:</b></p></td>
            ...
            <tr>
              <td><p><b>Duration(Months):</b></p></td>
              <td><p id="duration"></p></td>
            </tr>
            <tr>
              <td><p><b>Deduction per term:</b></p></td>
              <td><p id="deduct"></p></td>
            </tr>
        		<tr>
