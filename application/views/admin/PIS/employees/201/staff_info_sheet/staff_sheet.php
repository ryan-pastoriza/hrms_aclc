 ...
 * @Last Modified time: 2019-07-31 10:34:38
 */
		...
		<div style="border:1px solid black;margin-top:2px;">
			...
			<table class="table" width="100%;">
				<tr>
					...
					<td>
						:<input type="text" style="width:50%;border-left:none;border-top:none;border-right:none;border-bottom:1px solid black;" name="company_name">
					</td>
				</tr>
				<tr>
					<td>Date Hired</td>
					<td>
						:<input type="text" style="width:50%;border-left:none;border-top:none;border-right:none;border-bottom:1px solid black;" name="date_hired" disabled>
					</td>
				</tr>
				<tr>
					<td>Employment Status</td>
					<td>
						:<input type="text" style="width:50%;border-left:none;border-top:none;border-right:none;border-bottom:1px solid black;" name="emp_status" disabled>
					</td>
				</tr>
				<tr>
					<td>Position</td>
					<td>
						:<input type="text" style="width:50%;border-left:none;border-top:none;border-right:none;border-bottom:1px solid black;" name="position">
					</td>
				</tr>
				<tr>
					<td>Section/Program</td>
					<td>
						:<input type="text" style="width:50%;border-left:none;border-top:none;border-right:none;border-bottom:1px solid black;" name="section_program">
					</td>
				</tr>
				<tr>
					<td>Department</td>
					<td>
						:<input type="text" style="width:50%;border-left:none;border-top:none;border-right:none;border-bottom:1px solid black;" name="department" disabled>
					</td>
				</tr>
				<tr>
					<td>Division</td>
					<td>
						:<input type="text" style="width:50%;border-left:none;border-top:none;border-right:none;border-bottom:1px solid black;" name="division">
					</td>
				</tr>
				<tr>
					<td>Immediate Supervisor</td>
					<td>
						:<input type="text" style="width:50%;border-left:none;border-top:none;border-right:none;border-bottom:1px solid black;" name="immediate_supervisor" disabled>
					</td>
				</tr>
				<tr>
					<td>PHIC #</td>
					<td>
						:<input type="text" style="width:50%;border-left:none;border-top:none;border-right:none;border-bottom:1px solid black;" name="philhealth_no">
					</td>
				</tr>
				<tr>
					<td>SSS #</td>
					<td>
						:<input type="text" style="width:50%;border-left:none;border-top:none;border-right:none;border-bottom:1px solid black;" name="sss_no">
					</td>
				</tr>
				<tr>
					<td>TIN #</td>
					<td>
						:<input type="text" style="width:50%;border-left:none;border-top:none;border-right:none;border-bottom:1px solid black;" name="tin_no">
					</td>
				</tr>
				<tr>
					<td>PAGIBIG #</td>
					<td>
						:<input type="text" style="width:50%;border-left:none;border-top:none;border-right:none;border-bottom:1px solid black;" name="pagibig_no">
					</td>
				</tr>
			</table>
		</div>
