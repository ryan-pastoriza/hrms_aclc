 ...
 * @Last Modified time: 2016-04-14 08:44:55
 */
		...
		<td colspan="2" style="border:1px solid #CCC;">
			<div class="form-group">
			    <label style="padding-right:10px;">
			      <input type="radio" value="full-time" name="eaf_employment_desired" style="pointer-events:all;"> FULL-TIME
			    </label>
			    <label style="padding-right:10px;">
...
<div class="pull-right eaf_showButtons">
